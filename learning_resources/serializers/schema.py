...
class LearningResourceSerializerExtension(OpenApiSerializerExtension):
    target_class = (
        "learning_resources.serializers.learning_resources.LearningResourceSerializer"
    )
    ...
    def _map_learning_resource_base(self, auto_schema, direction):
        ...
        return ResolvedComponent(
            ...
            schema=auto_schema._map_basic_serializer(  # noqa: SLF001
                serializers.BaseLearningResourceSerializer, direction
            ),
        )

    def map_serializer(self, auto_schema, direction):
        sub_serializers = serializers.BaseLearningResourceSerializer.__subclasses__()
