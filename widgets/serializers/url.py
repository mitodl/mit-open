...
class URLWidgetConfigSerializer(WidgetConfigSerializer):
    ...
    url = ReactURLField(
        ...
        label="URL",
        under_text=(
            "Paste url from YouTube, New York Times, Instragram and more than 400"
            " content providers. Or any other web url"
        ),
        show_embed=True,
        required=False,
        allow_null=True,
    ...
    custom_html = ReactCharField(
        ...
        under_text=(
            "For security reasons, we only allow embed code from Twitter. If you have"
