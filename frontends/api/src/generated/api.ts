 ...
 * @export
 * @interface PatchedProgramLetterRequest
 */
export interface PatchedProgramLetterRequest {
  /**
   *
   * @type {ProgramCertificateRequest}
   * @memberof PatchedProgramLetterRequest
   */
  certificate?: ProgramCertificateRequest
}
/**
 ...
 *
 * @export
 * @interface ProgramCertificateRequest
 */
export interface ProgramCertificateRequest {
  /**
   *
   * @type {number}
   * @memberof ProgramCertificateRequest
   */
  user_edxorg_id?: number | null
  /**
   *
 ...
 * Serializer for Podcasts
 * @export
 * @interface ProgramLetterRequest
 */
export interface ProgramLetterRequest {
  /**
   *
   * @type {ProgramCertificateRequest}
   * @memberof ProgramLetterRequest
   */
  certificate: ProgramCertificateRequest
}
/**
 ...
 * @export
 */
export const CoursesNewListLevelEnum = {
  Advanced: "advanced",
  Graduate: "graduate",
  HighSchool: "high_school",
  Intermediate: "intermediate",
...
export type CoursesNewListLevelEnum =
  (typeof CoursesNewListLevelEnum)[keyof typeof CoursesNewListLevelEnum]
/**
 * @export
 */
 ...
 * @export
 */
export const LearningResourcesNewListLevelEnum = {
  Advanced: "advanced",
  Graduate: "graduate",
  HighSchool: "high_school",
  Intermediate: "intermediate",
...
export type LearningResourcesNewListLevelEnum =
  (typeof LearningResourcesNewListLevelEnum)[keyof typeof LearningResourcesNewListLevelEnum]
/**
 * @export
 */
...
export const LearningResourcesSearchApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {string} [q] The search text
     * @param {Array<LearningResourcesSearchRetrieveResourceTypeEnum>} [resource_type] The type of learning resource               * &#x60;course&#x60; - course * &#x60;program&#x60; - program * &#x60;learning_path&#x60; - learning path * &#x60;podcast&#x60; - podcast * &#x60;podcast_episode&#x60; - podcast episode
...
export const ProgramLettersApiAxiosParamCreator = function (
  ...
  return {
    /**
     * View for users
     * @param {ProgramLetterRequest} ProgramLetterRequest
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersCreate: async (
      ProgramLetterRequest: ProgramLetterRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'ProgramLetterRequest' is not null or undefined
      assertParamExists(
        "programLettersCreate",
        "ProgramLetterRequest",
        ProgramLetterRequest,
      )
      const localVarPath = `/api/v1/program_letters/`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    programLettersDestroy: async (
      id: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programLettersDestroy", "id", id)
     ...
     * View for users
     * @param {string} id A UUID string identifying this program letter.
     * @param {PatchedProgramLetterRequest} [PatchedProgramLetterRequest]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersPartialUpdate: async (
      id: string,
      PatchedProgramLetterRequest?: PatchedProgramLetterRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programLettersPartialUpdate", "id", id)
      const localVarPath = `/api/v1/program_letters/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
     ...
     * @throws {RequiredError}
     */
    programLettersUpdate: async (
      id: string,
      ProgramLetterRequest: ProgramLetterRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programLettersUpdate", "id", id)
      // verify required parameter 'ProgramLetterRequest' is not null or undefined
      assertParamExists(
        "programLettersUpdate",
        "ProgramLetterRequest",
        ProgramLetterRequest,
      )
      const localVarPath = `/api/v1/program_letters/{id}/`.replace(
...
export const ProgramLettersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programLettersCreate(
          ProgramLetterRequest,
          options,
        )
      const index = configuration?.serverIndex ?? 0
      const operationBasePath =
        operationServerMap["ProgramLettersApi.programLettersCreate"]?.[index]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programLettersDestroy(id, options)
      const index = configuration?.serverIndex ?? 0
      const operationBasePath =
        operationServerMap["ProgramLettersApi.programLettersDestroy"]?.[index]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async programLettersList(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ProgramLetter>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programLettersList(options)
      const index = configuration?.serverIndex ?? 0
      const operationBasePath =
        operationServerMap["ProgramLettersApi.programLettersList"]?.[index]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async programLettersPartialUpdate(
      id: string,
      PatchedProgramLetterRequest?: PatchedProgramLetterRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programLettersPartialUpdate(
          id,
          PatchedProgramLetterRequest,
          options,
        )
      const index = configuration?.serverIndex ?? 0
      const operationBasePath =
        operationServerMap["ProgramLettersApi.programLettersPartialUpdate"]?.[
          index
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programLettersUpdate(
          id,
          ProgramLetterRequest,
          options,
        )
      const index = configuration?.serverIndex ?? 0
      const operationBasePath =
        operationServerMap["ProgramLettersApi.programLettersUpdate"]?.[index]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const ProgramLettersApiFactory = function (
  ...
  return {
    /**
     * View for users
     * @param {ProgramLettersApiProgramLettersCreateRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersCreate(
      requestParameters: ProgramLettersApiProgramLettersCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProgramLetter> {
      return localVarFp
        .programLettersCreate(requestParameters.ProgramLetterRequest, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * View for users
     * @param {ProgramLettersApiProgramLettersDestroyRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersDestroy(
      requestParameters: ProgramLettersApiProgramLettersDestroyRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .programLettersDestroy(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * View for users
    ...
    programLettersList(
      ...
      return localVarFp
        .programLettersList(options)
        .then((request) => request(axios, basePath))
    },
    /**
     * View for users
     * @param {ProgramLettersApiProgramLettersPartialUpdateRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersPartialUpdate(
      requestParameters: ProgramLettersApiProgramLettersPartialUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProgramLetter> {
      return localVarFp
        .programLettersPartialUpdate(
          requestParameters.id,
          requestParameters.PatchedProgramLetterRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
    ...
    /**
     * View for users
     * @param {ProgramLettersApiProgramLettersUpdateRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    programLettersUpdate(
      requestParameters: ProgramLettersApiProgramLettersUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProgramLetter> {
      return localVarFp
        .programLettersUpdate(
          requestParameters.id,
          requestParameters.ProgramLetterRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
...
/**
 * Request parameters for programLettersCreate operation in ProgramLettersApi.
 * @export
 * @interface ProgramLettersApiProgramLettersCreateRequest
 */
export interface ProgramLettersApiProgramLettersCreateRequest {
  /**
   *
   * @type {ProgramLetterRequest}
   * @memberof ProgramLettersApiProgramLettersCreate
   */
  readonly ProgramLetterRequest: ProgramLetterRequest
}

/**
 * Request parameters for programLettersDestroy operation in ProgramLettersApi.
 * @export
 * @interface ProgramLettersApiProgramLettersDestroyRequest
 */
export interface ProgramLettersApiProgramLettersDestroyRequest {
  /**
   * A UUID string identifying this program letter.
   * @type {string}
   * @memberof ProgramLettersApiProgramLettersDestroy
   */
  readonly id: string
}

/**
 * Request parameters for programLettersPartialUpdate operation in ProgramLettersApi.
 * @export
 * @interface ProgramLettersApiProgramLettersPartialUpdateRequest
 */
export interface ProgramLettersApiProgramLettersPartialUpdateRequest {
  /**
   * A UUID string identifying this program letter.
   * @type {string}
   * @memberof ProgramLettersApiProgramLettersPartialUpdate
   */
  readonly id: string

  /**
   *
   * @type {PatchedProgramLetterRequest}
   * @memberof ProgramLettersApiProgramLettersPartialUpdate
   */
  readonly PatchedProgramLetterRequest?: PatchedProgramLetterRequest
}
...
/**
 * Request parameters for programLettersUpdate operation in ProgramLettersApi.
 * @export
 * @interface ProgramLettersApiProgramLettersUpdateRequest
 */
export interface ProgramLettersApiProgramLettersUpdateRequest {
  /**
   * A UUID string identifying this program letter.
   * @type {string}
   * @memberof ProgramLettersApiProgramLettersUpdate
   */
  readonly id: string
...
export class ProgramLettersApi extends BaseAPI {
   ...
   * @memberof ProgramLettersApi
   */
  public programLettersList(options?: RawAxiosRequestConfig) {
    return ProgramLettersApiFp(this.configuration)
      .programLettersList(options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ProgramLettersApi
   */
  public programLettersPartialUpdate(
    requestParameters: ProgramLettersApiProgramLettersPartialUpdateRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ProgramLettersApiFp(this.configuration)
 ...
 * @export
 */
export const ProgramsNewListLevelEnum = {
  Advanced: "advanced",
  Graduate: "graduate",
  HighSchool: "high_school",
  Intermediate: "intermediate",
...
export type ProgramsNewListLevelEnum =
  (typeof ProgramsNewListLevelEnum)[keyof typeof ProgramsNewListLevelEnum]
/**
 * @export
 */
